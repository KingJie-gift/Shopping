...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <c:if test="${small==null }">
    	<script>location.href="../Commodity_smallServletL";</script>
    </c:if>
            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                                    ...
                                    <a  class="dashboard_button button1" href="../Commodity_smallServletL?op=del&id=${s.commodity_small_id }" align="center" >
                                    <img src="icons/naifen.png" style="height: 76px; width: 122px; "/>
                                       ${s.commodity_small_name }(删除)
                                    </a>
                                    </c:forEach>
                            ...
                            <h2></h2>
                            <div>
                            <form action="../Commodity_smallServletL?op=add" method="post">
                            <p>
                            	<span style="font-size: 14px;font-weight: bolder;">添加新种类：</span>
                            	<input type="text" name="name" style="width: 453px; height: 44px"/>
                            	
                            </p>  
                            <span style="font-size: 14px;font-weight: bolder;" >商品种类：</span>&nbsp;&nbsp;&nbsp;&nbsp;  
                            <select name="comm" style="width: 115px; height: 35px">
                            	<option value="-1">请选择</option>
                            	<c:forEach var="c" items="${co }">
                            		<option value="${c.commodity_id }">${c.commodity_name }</option>
                            	</c:forEach>
                            </select>
                            <br/>
                            <br/>
