...
<script>
	$(function(){
		...
		var count=$("[name='name']").val().length;
		alert(count);
	...
	<div id="top">
		...
		<div id="bg_wrapper">
			...
			<div id="main" style="margin-bottom: 50px">
				<div id="content">
					<h2 class="jquery_tab_title xxx">商品详情</h2>
					<form method="post" action="../addSeervletL?op=add">
						...
						<table class="form_h xxx">
							<tr>
								...
								<td><input class="input-flex" type="text" name="name" required pattern="[\u4E00-\u9FA5a-zA-Z0-9_]{18,}"
									id="name"/>(最小输入18位)</td>
							</tr>

							<tr>
								<th><label for="mail">商品价格</label></th>
								<td><input class="input-flex" type="text" name="money" required
									id="mail" />/元</td>
							</tr>

							<tr>
								<th><label for="url">进货价格</label></th>
								<td><input class="input-flex" type="text" name="Jmoney" required
									id="url" />/元</td>
							</tr>

							<tr>
								<th><label for="flex">产品规格</label></th>
								<td><input class="input-flex" type="text" name="kg" required
									id="flex" /></td>
							</tr>
							...
							<tr>
								...
								<td><input class="input-flex" type="text" name="num" required
									id="flex" />/件</td>
							</tr>

							<tr>
								<th><label for="date">生产日期</label></th>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:13;font-weight: bolder;bolder;color: black ">商品品牌</span>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:13px;font-weight: bolder;color: black " >商品种类</span>
						<select style="width: 143px; margin-left: 20px; height: 34px" name="comm" class="xxx">
							<option value="-1">请选择</option>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-size:13;font-weight: bolder;bolder;color: black ">试用人群</span>
						<!-- <select style="width: 143px; margin-left: 20px; height: 34px" name="abap">
							<option value="-1">请选择</option> 
							</select>
						-->
							<c:forEach var="a" items="${abap }">
								<input class="xxx" name = "bc" type ="checkbox" value="${a.abapt_id }"/>${a.abapt_name }
							</c:forEach>
