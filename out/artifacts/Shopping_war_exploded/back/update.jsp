...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <c:if test="${pg==null }">
    	<script>location.href="../IndexServletL?op=sjsel";</script>
    </c:if>
            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                                    ...
                                    <h2>条件搜索</h2>
                                    <form action="../IndexServletL?op=sjsel" method="post">
                            ...
                            <br/>
                                <table width="80%" border="1" align="center">
                                	...
                                	<tr align="center">
                                		...
                                		<a href="Commodity_infoServlet2L?op=updateSJ&id=${p.commodity_info_id}">商品上架</a>
                                		</td>
                                	</tr>
                                	</c:forEach>
                                </table>
                                <p align="center">
                                <a href="IndexServletL?indexPage=1&sname=${sname }&sbrand=${sbrand}&op=sjsel">首页</a>
                                <a href="IndexServletL?indexPage=${pg.indexPage>1?pg.indexPage-1:1}&sname=${sname }&sbrand=${sbrand}&op=sjsel">上一页</a>
                                <a href="IndexServletL?indexPage=${pg.indexPage<pg.sumPage?pg.indexPage+1:pg.sumPage}&sname=${sname }&sbrand=${sbrand}&op=sjsel">下一页</a>
                                <a href="IndexServletL?indexPage=${pg.sumPage}&sname=${sname }&sbrand=${sbrand}&op=sjsel">末页</a>
