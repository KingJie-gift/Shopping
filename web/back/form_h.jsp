            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                            ...
                            <form method="post" action="Commodity_infoServlet2L?op=update&id=${find.commodity_info_id }">
                                <!-- form_h类用于格式化水平排列的表单 -->
                                <table class="form_h">
                                    <tr>
                                        <th>
                                        ...
                                        <td>
                                            <input class="input-flex" type="text" value="${find.commodity_info_name }" name="name" id="name"/>
                                        </td>
                                    </tr>
