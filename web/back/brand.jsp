            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                                    ...
                                    <c:forEach var="l" items="${brand }">
                                    <a  class="dashboard_button button1" href="../BrandServletL?op=del&id=${l.brand_id }" align="center" >
                            ...
                            <h2></h2>
                            <div>
                            <form action="../BrandServletL?op=add" method="post">
                            <p>
                            	<span style="font-size: 14px;font-weight: bolder;">添加新品牌：</span>
                            ...
                            <br/>
                            <p>
                            <input type="submit" value="添加品牌" style="height: 48px; width: 115px"/>
                            </p>
                            </form>
