...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <c:if test="${tempcommhome4==null}">
    	<script>location.href="../HomeServletL?op=sellQT";</script>
    </c:if>
            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                                    ...
                                    <h2 class="jquery_tab_title">其他</h2>
                                    <c:forEach var="l" items="${tempcommhome4}">
                                    <a  class="dashboard_button button1" href="HomeServletL?op=sellQT&type=selAll4&ppid=${l.commodity_id}" align="center" >
                    ...
                    <div id="sidebar">
                        <ul class="nav">
                            ...
                            <li><a class="headitem item4" href="#">商品删除</a>
