...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <c:if test="${tempcommhome2==null}">
    	<script>location.href="../HomeServletL?op=sel";</script>
    </c:if>
            	...
            	<div id="bg_wrapper">
                    ...
                    <div id="main">
                        <div id="content">
                                     ...
                                     <h2 class="jquery_tab_title">玩具</h2>
                                    <c:forEach var="l" items="${tempcommhome2}">
                                    <a  class="dashboard_button button1" href="HomeServletL?op=sel&type=selAll2&ppid=${l.brand_id}" align="center" >
