...
import dao.impl.CollectDaoImplw;
...
public class CollectDaow extends BaseDaow implements CollectDaoImplw {
    @Override
    ...
    private void getPublic(Collect collect) throws SQLException {
        ...
        Commodity_info commodity_info = new Commodity_infoDaow().commById(rs.getInt("Collect_commodity_info_id"));
