...
import dao.impl.ShopcartDaoImplw;
import entity.*;
...
public class ShopcartDaow extends BaseDaow implements ShopcartDaoImplw {
    @Override
    ...
    private void getAll(Shopcart shopcart) throws SQLException {
        ...
        Commodity_info commodity_info = new Commodity_infoDaow().commById(rs.getInt("Shopcart_ Bug _id"));
        ...
        Abapt abapt = new AbaptDaow().getAbapt(rs.getInt("Shopcart_abapt"));
